...
__global__ void D3Q19_RegVwPe_SNL_VNL_MRT_ts(const float * fIn, float * fOut,
					     const int * SNL,
					     const int * VW_nl, 
...
err_t jktFunction(int nlhs,mxArray * plhs[],int nrhs,mxArray * prhs[]){
  ...
  if(nrhs!=14)
    return err("Usage:D3Q19_RegVwPe_SNL_VNL_MRT_ts(fIn,fOut,SNL,VW_nl,PE_nl,rho_out,VNL,ux_p,uy_p,uz_p,M,Nx,Ny,Nz)");
  ...
  D3Q19_RegVwPe_SNL_VNL_MRT_ts<<<GRIDS,BLOCKS>>>(fIn,fOut,SNL,VW_nl,PE_nl,rho_out,
						 VNL, ux_p,uy_p,uz_p,
						 M,Nx,Ny,Nz);
