...
__global__ void D3Q19_RegBC_LBGK_ts(const float * fIn, float * fOut,
				    const int * SNL,
...
err_t jktFunction(int nlhs,mxArray * plhs[],int nrhs,mxArray * prhs[]){
  ...
  if(nrhs!=11)
    return err("Usage:D3Q19_RegBC_LBGK_ts(fIn,fOut,SNL,VW_nl,VW_uz,PE_nl,rho_out,omega,Nx,Ny,Nz)");
