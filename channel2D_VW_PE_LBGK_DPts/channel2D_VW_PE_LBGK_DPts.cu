...
__global__ void channel2D_VW_PE_LBGK_DPts(double * fOut, double * fIn, int * inl, 
...
err_t jktFunction(int nlhs, mxArray * plhs[], int nrhs, mxArray * prhs[]){
  ...
  if(nrhs!=10)
    return err("Usage: channel2D_VW_PE_LBGK_DPts(fOut,fIn,inl,onl,snl,ux_p,rho_out,nu,Nx,Ny");
  ...
  channel2D_VW_PE_LBGK_DPts<<<GRIDS,BLOCKS>>>(fOut,fIn,inl,onl,snl,ux_p,rho_out,nu,Nx,Ny);
