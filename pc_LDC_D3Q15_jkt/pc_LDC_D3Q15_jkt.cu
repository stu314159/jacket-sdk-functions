...
err_t jktFunction(int nlhs, mxArray *plhs[], int nrhs, mxArray * prhs[]){
  ...
  if(nrhs != 10)
    return err("Usage: pc_D3Q15_jkt(fIn,fEq,ex,ey,ez,ux_p,uy_p,uz_p,w,bc_nl)");
  ...
  mxArray * m_ey = prhs[3];
  mxArray * m_ez = prhs[4];
  mxArray * m_uxp = prhs[5];
  mxArray * m_uyp = prhs[6];
  mxArray * m_uzp = prhs[7];
  mxArray * m_w = prhs[8];
  mxArray * m_bcnl = prhs[9];
  ...
  pre_collideD3Q15<<<GRIDS,BLOCKS>>>(fEq_d,fIn_d,ex_d,ey_d,ez_d,
