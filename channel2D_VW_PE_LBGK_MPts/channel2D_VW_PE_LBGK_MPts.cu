...
__global__ void channel2D_VW_PE_LBGK_MPts(float * fOut, float * fIn, int * inl, 
...
err_t jktFunction(int nlhs, mxArray * plhs[], int nrhs, mxArray * prhs[]){
  ...
  if(nrhs!=10)
    return err("Usage: channel2D_VW_PE_LBGK_MPts(fOut,fIn,inl,onl,snl,ux_p,rho_out,nu,Nx,Ny");
  ...
  channel2D_VW_PE_LBGK_MPts<<<GRIDS,BLOCKS>>>(fOut,fIn,inl,onl,snl,ux_p,rho_out,nu,Nx,Ny);
