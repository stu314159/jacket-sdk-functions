...
set LIB=%VC%\ATLMFC\LIB\AMD64;%VC%\LIB\AMD64;%VS%\LIB\AMD64;%MATLAB%\extern\lib\win64\microsoft;%LIB%
...
rem set COMPILER=cl
set COMPILER=nvcc
set COMPFLAGS= -c -Xcompiler "/c /Zp8 /GR /W3 /EHs /D_CRT_SECURE_NO_DEPRECATE /D_SCL_SECURE_NO_DEPRECATE /D_SECURE_SCL=0 /DMATLAB_MEX_FILE /nologo /MT"
...
set LINKFLAGS= /dll /export:%ENTRYPOINT% /MAP /LIBPATH:"%LIBLOC%" /NODEFAULTLIB:msvcrt.lib /NODEFAULTLIB:libcmtd.lib %STD% %MEX% oleaut32.lib libcmt.lib /implib:%LIB_NAME%.x /MACHINE:x64 /MANIFEST
