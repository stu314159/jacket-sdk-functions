...
#----------------------------------------------------------------------------
            CC=nvcc
            CFLAGS='-O3 -Xcompiler "-fPIC -D_GNU_SOURCE -pthread -fno-common -no-cpp-precomp  -fexceptions -m32 -Wall -Werror -Wextra -Wno-unused-parameter -Wno-sign-compare"'
...
#
            CXX=g++
            CXXFLAGS='-fno-common -no-cpp-precomp -fexceptions -Wall -Werror'
            CXXLIBS="$MLIBS -lstdc++"
            CXXOPTIMFLAGS='-O3 -DNDEBUG'
            CXXDEBUGFLAGS='-g'
#
...
#----------------------------------------------------------------------------
            CC=nvcc
            CFLAGS='-O3 -Xcompiler "-fPIC -D_GNU_SOURCE -pthread -fno-common -no-cpp-precomp  -fexceptions -Wall -Werror -Wextra -Wno-unused-parameter -Wno-sign-compare" --ptxas-options=-v'
            CLIBS="$MLIBS -lm -lstdc++"
            COPTIMFLAGS='-Xcompiler "-O3 -funroll-loops -msse2 -DNDEBUG"'
            CDEBUGFLAGS='-g'
...
#
            CXX=g++
            CXXFLAGS='-arch x86_64 -fno-common -no-cpp-precomp -fexceptions -Wall -Werror'
            CXXLIBS="$MLIBS -lstdc++"
            CXXOPTIMFLAGS='-O3 -DNDEBUG'
            CXXDEBUGFLAGS='-g'
#
            ...
            LDFLAGS="-arch x86_64 -bundle -Wl,-flat_namespace -undefined suppress -Wl,-exported_symbols_list,$TMW_ROOT/extern/lib/$Arch/$MAPFILE"
            LDOPTIMFLAGS='-O'
            LDDEBUGFLAGS='-g'
#
            POSTLINK_CMDS=':'
